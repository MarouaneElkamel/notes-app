  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="notesApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Note" id="tag-note" data-cy="note" type="select" multiple name="notes">
                <option value="" key="0" />
                {notes
