          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lastModifiedAt')}>
                  Last Modified At <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedAt')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {noteList.map((note, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{note.lastModifiedAt ? <TextFormat type="date" value={note.lastModifiedAt} format={APP_DATE_FORMAT} /> : null}</td>
